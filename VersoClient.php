<?php
	...
	function GetOutboundAlertsLog()
	{
	    // Here you place the Verso API Url (TestUrl)
		$url = 'http://qa-verso-enterprise-service.azurewebsites.net/VersoApiService.svc/GetOutboundAlertLogs';

		// Here we create a sample user to authenticate in Verso
		$user = new ApiUser('mnavarro', '123');
